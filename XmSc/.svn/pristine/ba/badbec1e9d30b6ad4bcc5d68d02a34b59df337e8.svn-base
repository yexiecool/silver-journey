...
<head>
	...
	<body >
		 <header class="mui-bar mui-bar-nav" style="background: #141534;">
			...
			<h1 class="mui-title" style="color:#fbfaff !important;"  >找回密码</h1>
		</header> 
		<div class="mui-content" style="overflow: scroll; height: 100%; width:100%; background:url('${ctx}/xmMobile/images/kjbg2.jpg') no-repeat top center; background-size:100% 100%; padding: 0px;padding-top: 44px;">
			<form class="mui-input-group" style="  padding:10px 10px 0;  background:#141534">
				...
				<div class="mui-content-padded">
					<button id='sendNewpwd' class="mui-btn mui-btn-block"  data-loading-icon= "mui-spinner mui-spinner-custom" style="    background: #54d86b;">提交</button>
				</div>
			</form>
