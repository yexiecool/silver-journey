...
<script type="text/javascript">
	...
	function del(id) {
		if (confirm('确实要删除吗?')) {
			location.href = "${ctx}/shop/shopcolumn!delete.action?parentid=${parentid}&_id=" + id;
		}
	}
	function add() {
		$('#_id').val('');
	...
	function upd(id) {
		...
		$.post('${ctx}/shop/shopcolumn!upd.action', submitData, function(json) {
			$('#_id').val(json._id);
			$('#name').val(json.name);
			$('#type').val(json.type);
			$('#ioc').val(json.ioc);
	...
	<section>
		...
		<div class="mainpanel">
			...
			<form id="custinfoForm" name="custinfoForm" method="post"
				action="${contextPath}/shop/shopcolumn.action?parentid=${parentid}">
				<div class="pageheader">
					<h2>
						<i class="fa fa-user"></i> 熊猫 超市<span>栏目管理</span>
					</h2>
					 <div class="panelss ">
                <div class="panel-body fu10">
                    <div class="row-pad-5">
                        ...
                        <a href="javascript:page_submit(-1);" class="btn btn-primary">搜&nbsp;&nbsp;索</a>
                          ...
                          <sec:authorize ifAnyGranted="ROLE_153">
												...
												<td class="table-action">
													<div class="btn-group1">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															<sec:authorize ifAnyGranted="ROLE_154">
															<li><a href="javascript:upd('${bean._id}');"> <i
																	class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;修改</a>
															</li>
															</sec:authorize>	
															<sec:authorize ifAnyGranted="ROLE_155">				
    ...
    <div style="padding-top:2%">
        <div class="pl-10 pr-10 maring-a cmp500"
            ...
            <div class=" bg-bai border-radius3 overflow-hidden">
                ...
                <form id="inscxForm" action="${ctx }/shop/shopcolumn!save.action?fypage=${fypage}"
