...
<div class=" button_foot bg-bai zi-hui shadow-wai cmp640" style="z-index: 1;">
    ...
    <div class=" button_group1">
            ...
            onclick="window.location.href='${ctx}/suc/house!web.action?custid=${custid}&agid=${agid}&fromUserid=${fromUserid}'">
                <font size="4">
    ...
    <div class=" button_group1">
        <a href="${ctx}/suc/house!personalhome.action?custid=${custid}&agid=${agid}&fromUserid=${fromUserid}">
            <div class="bottom-bai zi-hui-wx txt-c weight500 line-right_bai pt-5 pb-5">
                <font size="4">
    ...
    <div class=" button_group1">
        <a href="${ctx}/suc/house!webadd.action?custid=${custid}&agid=${agid}&fromUserid=${fromUserid}">
            <div class="bottom-bai zi-hui-wx txt-c weight500 line-right_bai pt-5 pb-5">
                <font size="4">
