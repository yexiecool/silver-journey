...
<script type="text/javascript">
	...
	function del(id) {
		if (confirm('确实要删除吗?')) {
			...
			location.href = "${contextPath}/web/radio!delete.action?_id=" + id;
	...
	<section>
		...
		<div class="mainpanel">
			...
			<form id="custinfoForm" name="custinfoForm" method="post"
				action="${contextPath}/web/radio.action?">
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped table-success mb30">
									...
									<tbody>
										<c:forEach items="${radioList}" var="bean">
											<tr>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="inscxForm" action="${ctx }/web/radio!save.action"
						class="form-horizontal" method="post" >
						<input type="hidden" id="_id" name="_id" /> 
						<input type="hidden" id="lmid" name="lmid" /> 
						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">广播文件 <span
										class="asterisk">*</span> </label>
									<div class="col-sm-5">
