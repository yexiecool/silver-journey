...
<html>
		    		...
		    		var v = json.list; 
		    		 for(var i=0;i<v.length;i++){  
		    		    xszf+='<li class="mui-table-view-cell mui-media miner-media">'
		    		    	+'<p style="font-size:  14px;margin-bottom: 10px;">矿机型号：<span style="float: right; color:#7cc3df; padding-right:10px;">'+v[i].price+'</span></p>'
							...
							+'<button type="button" class="mui-btn miner-btnbuy" onclick="rechange('+v[i]._id+')" style="background:#54d86b; color:#fff; border:none; " >租用</button>'
							+'</div></div></li>';
					 }
		    		fypage++;
		    	}else{
	...
	<body>
		 <header class="mui-bar mui-bar-nav" style="background: #141534;">
			...
			<h1 class="mui-title" style="color:#fbfaff;" >矿机商场</h1>
		</header> 
		<div class="mui-content" style="overflow: scroll; height: 100%; background:url('${ctx}/xmMobile/images/kjbg2.jpg') no-repeat top center; background-size:100% 100%;">
		
			<div class="mui-row" style="border:none;">
				<div class="coin" >
					<span>消费钱包：</span>
			...
			<div class="mui-row" id="kjlist">
				<ul class="mui-table-view" style="background: none;margin-top: 0;">
