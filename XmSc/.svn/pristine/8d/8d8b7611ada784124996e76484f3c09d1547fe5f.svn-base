...
<head>
    ...
    <script>
        function submit() { 
            ...
            $.post('${ctx}/shop/shop!applyagent.action?custid=${custid}&agid=${agid}&lscode=${lscode}', submitData,
                    function (json) {
                        if (json.state==0) {
                            alert("报名成功请勿重复提交，谢谢配合");
                            window.location.href='${ctx}/shop/shop!index.action?custid=${custid}&agid=${agid}&lscode=${lscode}&comid=${id}&agid='+json.value; 
                        }
                    }, "json")
        }
    </script>
...
<main class="cmp640">
    <div class="div-group-5 pl-10 pr-10">
        ...
        <div class="size14 line-bottom-92 weight500 pt-10 pb-10 display-none" style="padding-left: 2px;">使用地地址</div>
        <div class="line-bottom-92 line-right-92 line-left-92 hang50 display-none" id='showCityPicker3'>
            
             <div class="col-4 pr-5 pl-5 pt-10">
                    <input id="province" class="width-10 bg-hui border-radius3 txt-c size14 zi-hui hang30 weight500" type="text"
                           name=""
            ...
            <div class="col-4 pr-5 pl-5 pt-10">
                    <input id="city" class="width-10 bg-hui border-radius3 txt-c size14 zi-hui hang30 weight500" type="text"
                           name=""
            ...
            <div class="col-4 pr-5 pl-5 pt-10">
                    <input id="county" class="width-10 bg-hui border-radius3 txt-c size14 zi-hui hang30 weight500" type="text"
                           name=""
