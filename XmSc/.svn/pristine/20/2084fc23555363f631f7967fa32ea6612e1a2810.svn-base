    ...
    <a href="#">
        <div class="col-12 clear div-group-5 pt-10 bg-huang zi-6 weight500">
            <font size="1">
                ...
                <div class="pt-10">
                    <font size="3">
                        <i class="zi-hong">￥<fmt:formatNumber value='${entity.jfdh}' pattern="0.0#"/>积分</i>
                    </font>
                </div>
...
<%@ include file="/webcom/shop-spec2.jsp" %>  
<script>
    function  check_task(){
       var submitData = { 
                type:"allshare",
...
<%@ include file="/webcom/jfbz-page.jsp" %> 
</body>
</html>