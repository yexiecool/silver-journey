        ...
        function pada_bl(totalPrice){
        	...
        	$.post('${ctx}/integral/miners!getPPBSrice.action?lscode=${lscode}', submitData,
        	    ...
        	    if(json.state==0){
        	    	...
        	    	if(totalPrice != '0.00'){
        		    	   $('.virtualcoin').html("PADA:"+(totalPrice/json.data).toFixed(2)); 
        		       }else{
        		    	   $('.virtualcoin').html("PADA:0.00");
        		       }	
        	   }			
        	},"json")
        }
                        ...
                        <font size="2">
                            ...
                            <div class=" pull-left weight500">
                                <div class="sl" style="line-height:24px;">
                                    ...
                                    <span class="virtualcoin">PADA:0.00</span>
                                </div>
                            </div>
                            <div class="border-radius3 pull-right overflow-hidden">
                                ...
                                <div class="pull-left overflow-hidden img-wh30">
                                    <input class="size12 txt-c zi-hui gray_input weight500 width-10 button-kong"
                                           id="quantity"
                                           name=""
                                           type="text" onchange="keyup()" value="1" style="padding:0px; height:30px;" />
                                </div> 
