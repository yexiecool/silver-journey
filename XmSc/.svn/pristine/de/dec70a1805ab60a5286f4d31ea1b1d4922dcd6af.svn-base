...
<head>
		...
		<style type="text/css">
			*{
			...
			.money_box span{ color:#7cc3df !important; }

			.money_box input{ color:#7cc3df !important; }
			/*确认申请提现弹框样式*/
			.Submission_box{
				width: 100%;
				height:100%;
			...
			.Method{ background:#7cc3df !important; color:#fbfaff; border:none !important;  }
		</style>
	</head>
	...
	<body style="background: #1d2434; padding-top:50px;" >
		 ...
		 <header class="mui-bar mui-bar-nav" style="background:#1d2434;">
			...
			<h1 class="mui-title" style="color:#fbfaff  !important;">佣金提现</h1>
		</header>
		<div class="payment_money">	
			...
			<p style="font-size:12px;color:#7cc3df;">本次提现收取10%的手续费。<a href="${ctx}/integral/commission!list.action?custid=${custid}&agid=${agid}&lscode=${lscode}" style="float:right;color:#E4393C">提现记录</a></p>
		</div>
		<!--确认申请提现弹框-->
