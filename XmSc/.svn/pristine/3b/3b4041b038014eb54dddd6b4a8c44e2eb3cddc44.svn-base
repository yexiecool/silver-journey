...
<li>
<a href="${ip}/cmp/pingche!city.action?toUser=${toUser}&city=&bz=1">全国</a>
</li>
<#list rmdictList as dict> 
<li>
<a href="${ip}/cmp/pingche!city.action?toUser=${toUser}&city=${dict.key }&bz=1">${dict.value }</a>
</li>
</#list>
...
<div id="city${dict.zm}">
	...
	<ul id="cities" class="city_lst" style="display: block;">
		...
		<li><a href="${ip}/cmp/pingche!city.action?toUser=${toUser}&city=${areatwo.key }&bz=1">${areatwo.value}</a></li>
		</#list>
