		    			 ...
		    			 if(v[i].enddate!=null){
		    				 if(v[i].kj!=null){
		    					  xszf+='<li class="mui-table-view-cell mui-media miner-media">'
										...
										+'<button type="button" class="mui-btn miner-btnbuy" onclick="find('+v[i]._id+')" style="background:#7cc3df; color:#fbfaff;boder:none  !important;">查看</button>'
										+'</div></div></li>';
		    				 }else{
		    					  xszf+='<li class="mui-table-view-cell mui-media miner-media">'
...
<!-- background:#141534; -->
	...
	<body style=" background:url('${ctx}/xmMobile/images/kjbg2.jpg') no-repeat top center; background-size:100% 100%;" >
		<header class="mui-bar mui-bar-nav" style="background: #141534;">
			...
			<h1 class="mui-title" style="color:#fbfaff;">我的矿机</h1>
		</header>
		<!--background: url('${ctx}/xmMobile/img/minerback.jpg') no-repeat;-->
		<div class="mui-content"  style="overflow: scroll; padding-bottom:60px; background: url('${ctx}/xmMobile/img/kjbj.jpg') no-repeat; height:100%; background-size: 100% 100%;">
			
			<ul class="mui-table-view"  style="background: none; border:none; margin-top: 0px;padding-bottom: 0;">
				
				
			</ul>
			<style>
			    .mgjcon img{ width:100%; }
			</style>
			<!--没有矿机-->
			<ul class="mgjcon"  style=" display:none; margin-top: 0px;padding-bottom: 0;">
			  <li style="border:none;  padding:10px; text-align: center;">
			 	 <p style="font-size:20px; color:#7cc3df !important; padding-top:30px;" >您还没有矿机</p>
			      <img src="${ctx}/xmMobile/images/cry.png" />
			  </li>
			</ul>
