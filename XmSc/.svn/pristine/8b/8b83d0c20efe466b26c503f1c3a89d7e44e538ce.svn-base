        ...
        <form id="custinfoForm" name="custinfoForm" method="post"
            ...
            <div class="panelss ">
                <div class="panel-body fu10">
                    ...
                    <%--  商品<input type="file" name="excel" onchange="window.location.href='${ctx }/shop/shoppro!productReadExcel.action?comid=${comid}&fypage=${fypage}'" />  --%>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-primary table-action mb30 table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th class="th5 table-action">编号</th>
                                ...
                                <c:forEach items="${ProductInfoList}" var="bean">
                                    <tr class="table-action">
                                        ...
                                        <td>${bean._id}</td> 
                                        <td>
                                         <c:if test="${bean.logo.indexOf('http') !=-1}"><img src="${bean.logo}" style="height:25px;"></c:if> 
                                         <c:if test="${bean.logo.indexOf('http') ==-1}"><img src="${filehttp}${bean.logo}" style="height:25px;"></c:if> 
                                        </td>
