...
public class SlideAction extends GeneralAction<Slide>{
	...
	public String save() throws Exception {
		...
		try {
			...
			String custid=SpringSecurityUtils.getCurrentUser().getId();  
			entity.setCustid(custid);
			if(null != entity.getShopId() && !"".equals(entity.getShopId())){
				entity.setUrl("shop!index.action?comid="+entity.getShopId());
			}
			else if (null != entity.getProductId() && !"".equals(entity.getProductId())){
				entity.setUrl("shop!shopproduct.action?pid="+entity.getProductId());
			}
