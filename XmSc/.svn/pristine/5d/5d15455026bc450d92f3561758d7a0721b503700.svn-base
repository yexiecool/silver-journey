...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/suc/integral!extract.action" >
   ...
   <div class="panelss ">
                <div class="panel-body fu10">
                    <div class="row-pad-5">
			            ...
			            <div class="form-group col-sm-2">
			                 <input type="text" id="remark" name="remark" value="${remark}" placeholder="输入返还内容"  class="form-control" />
			            </div>
