...
<html>
    ...
    <body style="background: #fff;">
    	<header class="mui-bar mui-bar-nav">
    	    <a class=" mui-icon mui-icon-undo mui-icon-left-nav mui-pull-left" style="color: #000;" href="javascript:history.go(-1)"></a>
    	...
    	<div class="mui-content" style="background: #fff;padding: 0 20px;padding-top: 44px;">
			...
			<div class="box">
				...
				<div class="mui-input-row" style="position: relative;">
					...
					<div class="mui-btn mui-btn-grey verBtn" onclick="sendsms()">获取验证码</div>
				</div>
				<div class="mui-input-row">
					<label>密码</label>
