...
public class GetAllFunc {
	 ...
	 * rmb汇率
	 */
	public static HashMap<String,Exchangerate> rmbrate = new HashMap<String, Exchangerate>();
	/**
	 * pada汇率
	 */
	public static HashMap<String,PadaChangerate> padarate = new HashMap<String, PadaChangerate>();
	/**
	 * eth汇率
	 */
	public static HashMap<String,EthChangerate> ethrate = new HashMap<String, EthChangerate>();
	/**
	 * btc汇率
	 */
	public static HashMap<String,BtcChangerate> btcarate = new HashMap<String, BtcChangerate>();
