...
public class LoginAction extends ActionSupport {
	...
	public String sjsignup() {
		String lscode=Struts2Utils.getParameter("custid");
		String custid=Struts2Utils.getParameter("lscode");
	...
	public String tenants() {
		...
		//获取用户id 
		String  fromUserid=wwzservice.getfromUseridfromcode(lscode);
		...
		if(db != null){
			...
			System.out.println("----curruser:"+user.getNumber());
			System.out.println("----curruser status:"+user.getAudit_status());
			Struts2Utils.getRequest().setAttribute("curruser", user);
			//查看用户是否有开店申请 如果有的话返回到提示界面
			if(user.getLisense_number()!="" && user.getLisense_number()!=null && user.getCompany_name()!="" && user.getCompany_name()!=null) {
				return "examine";
			}
		}
