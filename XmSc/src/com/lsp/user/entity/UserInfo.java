...
public class UserInfo extends ReflectionDBObject {
	...
	private int mb;
	private String area;
	private String province; //用户资料所属的省分
	private String city;
	
	private String userName;//真实姓名
	private String id_card;//身份证号码
	private String id_card_front;//身份证正面照 -个人
	private String id_card_reverse;//身份证反面照-个人
	private String company_name;//公司名称
	private String lisense_number;//营业证号码
	private String lisense_photo;//营业证照片
	private int audit_status;//审核状态  1为通过  2为不通过
	
	private String shop_id_card;//身份证号码-商城入住
	private String shop_id_card_front;//身份证正面照 -商城入住
	private String shop_id_card_reverse;//身份证反面照- 商城入住
	private String shop_mobile;//商城入住电话
	private String comments; //商品内容
	...
	/**
	 * 代理商   类型
	 * 1-省  2-市  3-县   4-部门        矿机会员类型 100-微型矿机   101-小型矿机 102-中型矿机 103-大型矿机
	 * 2018/6/20
	 */
	...
	private int recommend;  // 是否填写推荐人 0未更新 1 已更新
	...
	public String getShop_id_card_front() {
		return shop_id_card_front;
	}

	public void setShop_id_card_front(String shop_id_card_front) {
		this.shop_id_card_front = shop_id_card_front;
	}

	public String getShop_id_card_reverse() {
		return shop_id_card_reverse;
	}

	public void setShop_id_card_reverse(String shop_id_card_reverse) {
		this.shop_id_card_reverse = shop_id_card_reverse;
	}
