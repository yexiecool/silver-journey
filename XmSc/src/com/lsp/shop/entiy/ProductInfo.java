...
public class ProductInfo extends ReflectionDBObject{
    ...
    private int discountType;		//优惠类型 0:不参与优惠；1:浪一圈;2:逛庙会;3:赶集去
    
    private int columnid;  // 商品栏目编号
	...
	public String getGgcontext() {
		return ggcontext;
	}

	public void setGgcontext(String ggcontext) {
	...
	public String toString() {
		return "ProductInfo [ptitle=" + ptitle + ", no=" + no + ", bq=" + bq + ", num=" + num + ", gmnum=" + gmnum
				+ ", price=" + price + ", oldprice=" + oldprice + ", cost=" + cost + ", logo=" + logo + ", picUrl="
				+ picUrl + ", url=" + url + ", but1=" + but1 + ", gm1=" + gm1 + ", but2=" + but2 + ", gm2=" + gm2
				+ ", summary=" + summary + ", context=" + context + ", rule=" + rule + ", type=" + type
				+ ", createdate=" + createdate + ", comid=" + comid + ", toUser=" + toUser + ", sort=" + sort + ", mb="
				+ mb + ", gmcs=" + gmcs + ", remind=" + remind + ", custid=" + custid + ", tglx=" + tglx + ", hylx="
				+ hylx + ", kjprice=" + kjprice + ", lowprice=" + lowprice + ", pcount=" + pcount + ", pprice=" + pprice
				+ ", unit=" + unit + ", kdprice=" + kdprice + ", jffh=" + jffh + ", isxs=" + isxs + ", jfdh=" + jfdh
				+ ", dlprice=" + dlprice + ", percent=" + percent + ", goodstype=" + goodstype + ", typeid=" + typeid
				+ ", mintypeid=" + mintypeid + ", thirdtypeid=" + thirdtypeid + ", discountType=" + discountType + "]";
	}
