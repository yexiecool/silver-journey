	...
	public void approval() throws Exception{
		...
		if(dbObject !=null){
			...
			if(info.getState() == 0){
				...
				wwzService.addjfoid(refundpada, fid, "returngood_add", SysConfig.getProperty("custid"), 0, 1, 0,oid,"退货");
				...
				wwzService.deljfoid(refundpada, account, "returngood_jian", SysConfig.getProperty("custid"), 0, 1, 0,oid,"退货");
