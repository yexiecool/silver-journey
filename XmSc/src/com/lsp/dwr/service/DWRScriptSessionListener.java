...
public class DWRScriptSessionListener implements ScriptSessionListener {  
     ...
     public void sessionCreated(ScriptSessionEvent event) {  
           ...
           System. out.println( "添加session: " + session.getId() + " scriptSession: " + scriptSession.getId() + "is created!");  
     }  
     ...
     public void sessionDestroyed(ScriptSessionEvent event) {  
           ...
           System. out.println( "移除session: " + session.getId() + " scriptSession: " + scriptSession.getId() + "is destroyed!");  
     }  
