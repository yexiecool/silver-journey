    ...
    <body style="background: #fff;">
    	...
    	<div class="mui-content" style="background: #fff;padding: 0 20px;padding-top: 44px;">
			...
			<div class="box">
				...
				<div class="mui-input-row">
					<label>邮箱</label>
					<input id='email' type="text" class=" mui-input " placeholder="请填写可用的邮箱">
				</div>
				<div class="mui-input-row">
					<label>身份证号</label>
				...
				<div style="width: 100%;height: 20px;font-size: 12px;text-align: right;margin-top: 10px;cursor: pointer;" >
						<span id="Agreement"  style="margin-top:5px; float:right;" >用户协议</span>
						<input type="checkbox" name="cb1" id="cb1" value=""  style="margin:7px 5px 0 0; float:right;" />
			...
			$(function() {
				...
				$('#reg').click(function(){
					...
					if(status=='1'){//个人注册
						...
						$.ajax({
							type:"post",
							url:"${ctx}/user/fromuser!shopsignup.action",
							async:true,
							data:{
								tel:$('#phone1').val(),
								lscode:'${lscode}',
