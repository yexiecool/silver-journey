...
<html>
	...
	<body style="background:url('${ctx}/xmMobile/images/kjbg2.jpg') no-repeat top center; background-size:100% 100%; " >
		<header class="mui-bar mui-bar-nav" style="background: #141534;" >
			...
			<h1 class="mui-title" style="color:#fbfaff;" >交易所</h1>
		</header>
		<style>
		 .mui-row label{color:#7cc3df; }
		  .mui-row input{color:#7cc3df; }
		...
		<div class="mui-content" style="background:#141534; padding-left:10px ;padding-right: 10px;">
			<div class="mui-row">			    
				...
				<div class="mui-input-row">
					...
					<span id="fsyzm" class="verBtn" onclick="send()">发送验证码</span>		
				</div>
				<div class="mui-input-row">
					<label for="">验证码：</label>
			...
			<div class="mui-row" style="width: 100%;display: flex;justify-content: center;margin-top: 20px;">
				<button class="mui-btn mui-btn-block liftBtn" style="background:#54d86b; width:100%; height:40px; padding:0px; line-height:40px;" >申请到交易所</button>
			</div>
			<div class="modal">
