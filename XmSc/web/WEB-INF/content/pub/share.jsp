	...
	<div class="row">
    	<div class="col-md-5">
        	<div class="big-divice">
            	...
            	<div class="kuang"> 
            	<c:if test="${entity.type=='music'}">
            	<div data-role="widget" data-widget="music90" class="music90">

                  <a href="javascript:void(0);" class="btn_music on"  onclick="playbox.init(this).play();"></a><audio id="audio" loop src="${entity.url}"  autoplay="autoplay" style="pointer-events:none;display:none;width:0!important;height:0!important;"></audio>
                </div>  
            	</c:if>
            	<c:if test="${entity.type=='video'}">
            	<div style="width: 100%; height: 200px">
            	<%@include file="/webcom/video.jsp"%>
            	</div>
            	
            	</c:if>
            	 <c:if test="${entity.url=='video'}">
