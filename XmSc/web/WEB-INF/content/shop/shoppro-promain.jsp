...
//                              if (i & 1 != 0) {
                                	...
                                	html +='<li class="mui-table-view-cell mui-media mui-col-xs-6" >'
                						...
                						if(v[i].price!=null){
                							html+='<span class="similar-product-price"><span>￥</span>'+ v[i].price+'</span>';
                						} 
...
//                              }
       ...
       function goods_search(){
       	...
       	if(goods_name!=""&&goods_name!=null){
       		window.location.href="${ctx}/shop/shoppro!promain.action?custid=${custid}&agid=${agid}&lscode=${lscode}&hylx=${hylx}&ptitle="+goods_name;
       	}
       }
		</script>
	</head>
