        ...
        <div class="row-pad-5">
            ...
            <div class="form-group col-sm-1d">
            	<select  id="sel_state"  name="state" class="form-control "  data-placeholder="请选择">
                    			...
                    			<option value="2">确认收款等待发货</option><!-- 已购买 -->
                ...
                <table class="table table-striped table-primary mb30" >
                    <thead>
                      <tr> 
						...
						<th class="th4">电话</th>
						<th class="th6">地址</th>
                        <th class="th6">下单日期</th>
                        <th class="th6">收货日期</th>
                        <th class="th6">支付方式</th>
                    ...
                    <tbody>
                      ...
                      <tr>  
                       <td>${bean.vip_no}</td>
                        ...
                        <td><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${bean.deliveryDate}" /></td>
                        <td> 
                          <c:if test="${bean.zflx==0}"></c:if>
                  		  <c:if test="${bean.zflx==1}">比特币</c:if>
                    	  <c:if test="${bean.zflx==2}">以太坊</c:if>
                          <c:if test="${bean.zflx==3}">PP币</c:if>
                          <c:if test="${bean.zflx==4}">微信支付</c:if>
