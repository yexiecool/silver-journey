...
<section>
    ...
    <div class="mainpanel">
        ...
        <form id="custinfoForm" name="custinfoForm" method="post"
              action="${contextPath}/shop/shoppro!barlist.action?id=${id}">
            <div class="pageheader">
                <h2><i class="fa fa-user"></i> 微网站<span>砍价管理</span></h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-primary table-action mb30">
                                ...
                                <tr>
                                    ...
                                    <th class="th5 table-action">最低价格</th> 
                                ...
                                <c:forEach items="${list}" var="bean">
                                    <tr class="table-action">
                                        ...
                                        <td><img src="${filehttp}${bean.pro.logo}" style="height:25px;"></td>
                                        <td title="${bean.pro.ptitle}">
                                            <div class="sl">${bean.pro.ptitle}</div>
                                        </td>
                                        <td><fmt:formatNumber value='${bean.pro.lowprice}' pattern="0.0#"/></td>
                                        <td><fmt:formatNumber value='${bean.pro.price}' pattern="0.0#"/></td>
                                        ...
                                        <td class="table-action">
                                            ...
                                            <div class="btn-group1">
                                                ...
                                                <ul role="menu" class="dropdown-menu pull-right">
                                                    ...
                                                    <li>
                                                        <a href="${contextPath}/shop/shoppro!bardetaillist.action?id=${bean._id}">
                                                            <i class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;砍价详情</a>
                                                    </li>
