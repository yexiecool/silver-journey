...
<html lang="en">
	...
	<body>
		<header class="mui-bar mui-bar-nav">
    	    ...
    	    <h1 class="mui-title">线下招商会列表</h1>
    	</header>
		<div class="mui-content" style="background: #ececec;">
		    <ul class="mui-table-view" style="margin-top: 0;padding-bottom: 0;">
		    	<c:forEach items="${joinlist }" var="obj">
		    	
		    		<li class="mui-table-view-cell">
		    			<c:if test="${not empty obj.title}">
			    			<a class="mui-navigate-right"   href="javascript:selectdetail('${obj._id}');">
			                    <div class="mui-table">
