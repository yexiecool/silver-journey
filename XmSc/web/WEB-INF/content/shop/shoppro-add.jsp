...
<script type="text/javascript">
	...
	function getchild(id) {
		...
		$.post('${ctx}/shop/shoppro!get.action', submitData, function(json) {
			if (json.state == 0) {
				var list = json.list;
				var options = "<option  value=''>请选择</option>";
				for (var i = 0; i < list.length; i++) {
					options += "<option  value="+list[i]._id+">" + list[i].name
							+ "</option>";
				}
				$("#mintypeid").html(options);
				if ("${entity.typeid}" == $("#typeid").val()) {
					$("#mintypeid").val("${entity.mintypeid}")
							.trigger("change");
		...
		$.post('${ctx}/shop/shoppro!get.action', submitData, function(json) {
			if (json.state == 0) {
				...
				if ("${entity.mintypeid}" == $("#mintypeid").val()) {
					$("#thirdtypeid").val("${entity.thirdtypeid}").trigger(
							"change");
				} else {
...
<body>
			...
			<div class="row">
				<div class="col-md-12">
					<form class="form-horizontal" id="custinfoForm" method="post"
						...
						<input id="_id" name="_id" value="<s:property value='_id'/>"
							type="hidden" /> <input type="hidden" id="logo"
							value="<s:property value='logo'/>" name="logo" /> <input
							type="hidden" id="comid" value="${comid}" name="comid" />
						<%-- <input type="hidden" id="goodstype" value="${goodstype}" name="goodstype"/> --%>
						<div class="div-group-10 overflow-hidden">
							<!--左边项目-->
							<div class="overflow-hidden">
								<div
									class=" div-group-10 pb-25 bg-bai border-radius5 overflow-hidden">
									<div class="clear col-2 pl-10 overflow-hidden">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">
											商品logo<i class="size12 zi-hui">（仅需一张）（推荐上传图片大小：400px X
												400px）</i>
										</div>
										<div
											class="line-bottom line-right line-left1 div-group-5 pt-10 pb-10 overflow-hidden">
											<div class="col-6">
								...
								<div class="clear pt-25">
									...
									<div class="col-2 pl-10">
										<div class="size14 weight500 pt-10 pb-10"
											style="padding-left: 2px;">商品一级分类</div>
										<div class="overflow-hidden">
											<select id="typeid" name="typeid" class="select2"
												data-placeholder="请选择">
									...
									<div class="col-2 pl-10" id="show_mintype">
										<div class="size14 weight500 pt-10 pb-10"
											style="padding-left: 2px;">商品二级分类</div>
										<div class="overflow-hidden">
											<select id="mintypeid" name="mintypeid" class="select2"
												data-placeholder="请选择">
									...
									<div class="col-2 pl-10" id="show_thirdtype">
										<div class="size14 weight500 pt-10 pb-10"
											style="padding-left: 2px;">商品三级分类</div>
										<div class="overflow-hidden">
											<select id="thirdtypeid" name="thirdtypeid" class="select2"
												data-placeholder="请选择">
									...
									<div class="col-2 pl-10">
										<div class="size14  weight500 pt-10 pb-10"
											style="padding-left: 2px;">模板</div>
										<div class="overflow-hidden">
											<select id="mb" name="mb" class="select2"
												data-placeholder="请选择">
									...
									<div class="pt-25 clear">
										<div class="col-2 pl-10">
											...
											<div
												...
												<input
													class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
													type="text" id="sort" value="<s:property value='sort'/>"
													name="sort" placeholder="请输入序号">
											</div>
										</div>
										<div class="col-2 pl-10">
											<div class="size14 line-bottom weight500 pt-10 pb-10"
												style="padding-left: 2px;">分享说明</div>
											<div
												class="line-bottom line-right line-left1 hang40 overflow-hidden">
												<input
													class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
													type="text" id="summary"
													value="<s:property value='summary'/>" name="summary"
													placeholder="请输入分享说明">
											</div>
										</div>
										<div class="col-2 pl-10">
											<div class="size14 line-bottom weight500 pt-10 pb-10"
												style="padding-left: 2px;">外部链接</div>
											<div
												class="line-bottom line-right line-left1 hang40 overflow-hidden">
												<input
													class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
													type="text" id="url" value="<s:property value='url'/>"
													name="url" placeholder="外部链接">
											</div>
										</div>
									</div>
									<div class="col-2 pl-10">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">成本价格</div>
										<div
											class="line-bottom line-right line-left1 hang40 overflow-hidden">
											<input
												class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
												type="text" id="cost" value="<s:property value='cost'/>"
												name="cost" placeholder="成本价格 ">
										</div>
									</div>
									<div class="col-2 pl-10">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">销售价格</div>
										<div
											class="line-bottom line-right line-left1 hang40 overflow-hidden">
											<input
												class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
												type="text" id="price" value="<s:property value='price'/>"
												name="price" placeholder="请输入价格">
										</div>
									</div>
									<div class="col-2 pl-10">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">市场价格</div>
										<div
											class="line-bottom line-right line-left1 hang40 overflow-hidden">
											<input
												class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
												type="text" id="oldprice"
												value="<s:property value='oldprice'/>" name="oldprice"
												placeholder="请输入市场价格">
										</div>
									</div>
									...
									<div class="col-2 pl-10">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">库存数量</div>
										<div
											class="line-bottom line-right line-left1 hang40 overflow-hidden">
											<input
												class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
												type="text" id="num" value="<s:property value='num'/>"
												name="num" placeholder="请输入库存数量">
										</div>
									</div>
									<div class="col-2 pl-10">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">已售数量</div>
										<div
											class="line-bottom line-right line-left1 hang40 overflow-hidden">
											<input
												class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
												type="text" id="gmnum" value="<s:property value='gmnum'/>"
												name="gmnum" placeholder="请输入已售数量">
										</div>
									</div>
									...
									<div class="col-2 pl-10">
										<div class="size14 weight500 pt-10 pb-10"
											style="padding-left: 2px;">是否显示</div>
										<div class="overflow-hidden">
									...
									<div class="col-2 pl-10">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">快递费用</div>
										<div
											class="line-bottom line-right line-left1 hang40 overflow-hidden">
											<input
												class="width-10 size14 zi-hui hang40 pl-10 pr-10 weight100"
												type="text" id="kdprice"
												value="<s:property value='kdprice'/>" name="kdprice"
												placeholder="请输入快递费用">
										</div>
									</div>
									<div class="col-2 pl-10">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">优惠类型</div>
										<div
											class="line-bottom line-right line-left1 hang40 overflow-hidden">
											<select id="discountType" name="discountType" class="select2">
												<option value="0">不参与活动</option>
												<option value="1">浪一圈</option>
												<option value="2">逛庙会</option>
												<option value="3">赶集去</option>
											</select>
										</div>
									</div>
									...
									<div class="col-2 pl-10">
										<div class="size14 line-bottom weight500 pt-10 pb-10"
											style="padding-left: 2px;">商品栏目</div>
										<div
											class="line-bottom line-right line-left1 hang40 overflow-hidden">
											<select id="columnid" name="columnid" class="select2">
												<option value="0">无栏目</option>
								...
								<div class="pt-10 clear">
									...
									规格参数：
									<div class="div-group-10 border-radius5 bg-bai">
										<textarea name="ggcontext" id="ggcontext" class="ckeditor"
											rows="10" cols="38">${ggcontext}</textarea>
										<script id="editor" type="text/plain"
											style="width: 100%; height: 300px;">${ggcontext}</script>
									</div>
									包装售后：
									<div class="div-group-10 border-radius5 bg-bai">
										<textarea name="shcontext" id="shcontext" class="ckeditor"
											rows="10" cols="38">${shcontext}</textarea>
										<script id="editor" type="text/plain"
											style="width: 100%; height: 300px;">${shcontext}</script>
									</div>
	...
	<script type="text/javascript">
		...
		var editor1 = CKEDITOR.replace('ggcontext');
		var editor2 = CKEDITOR.replace('shcontext');
		function checksubmit() {
			$("#context").val(editor.getData());
			$("#ggcontext").val(editor1.getData());
			$("#shcontext").val(editor2.getData());
			$('#custinfoForm').submit();
		}
	</script>
