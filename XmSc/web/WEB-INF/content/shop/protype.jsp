...
<script type="text/javascript">
	...
	function del(id) {
		if (confirm('确实要删除吗?')) {
			location.href = "${ctx}/shop/protype!delete.action?parentid=${parentid}&_id=" + id;
		}
	}
	function add() {
		$('#_id').val('');
	...
	function upd(id) {
		...
		$.post('${ctx}/shop/protype!upd.action', submitData, function(json) {
			$('#_id').val(json._id);
			$('#name').val(json.name);
			$('#type').val(json.type);
			$('#ioc').val(json.ioc);
	...
	<section>
		...
		<div class="mainpanel">
			...
			<form id="custinfoForm" name="custinfoForm" method="post"
				action="${contextPath}/shop/protype.action?parentid=${parentid}">
				<div class="pageheader">
                    ...
                    <div class="input-group ">
                        <div style="border-radius:3px; height:40px;padding-left:10px;" class="btn-primary">
                            <sec:authorize ifAnyGranted="ROLE_111">
												...
												<td class="table-action">
													<div class="btn-group1">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															<sec:authorize ifAnyGranted="ROLE_112">
															<li><a href="javascript:upd('${bean._id}');"> <i
																	class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;修改</a>
															</li>
															</sec:authorize>
															<sec:authorize ifAnyGranted="ROLE_114">
															<li><a href="${contextPath}/shop/protype.action?parentid=${bean._id}"> <i
																	class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;管理分类</a>
															</li>
															</sec:authorize>
															<sec:authorize ifAnyGranted="ROLE_113">
    ...
    <div style="padding-top:2%">
        <div class="pl-10 pr-10 maring-a cmp500"
            ...
            <div class=" bg-bai border-radius3 overflow-hidden">
                ...
                <form id="inscxForm" action="${ctx }/shop/protype!save.action?fypage=${fypage}"
                    ...
                    <div class="pt-15 pl-15 pr-15 overflow-auto" style="height:490px;">
                       ...
                       <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div>
                                <div class="col-sm-8 mb-20" style="padding:0px;">
                                    <input type="text" id="img" name="img" class=" form-control hang40"/>
                                </div>
                                <div class="col-sm-4 mb-20" style="padding:0px;position: relative;"
                                     onclick="pz('img','450','150',false)">
                                    <div class="btn btn-primary"
                                         style="width: 100%;line-height: 20px;height:40px;">
                                        上传
                                    </div>
