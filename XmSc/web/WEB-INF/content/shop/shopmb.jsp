                            ...
                            <table class="table table-striped table-action table-primary mb30 table-bordered">
                                ...
                                <c:forEach items="${shopmbList}" var="bean">
                                    <tr>
                                        <td>${bean._id}</td>
                                        <td>${bean.name}</td>
                                        <td><c:if test="${bean.type==3}">大众区</c:if><c:if test="${bean.type==4}">会员区</c:if><c:if test="${bean.type==5}">特约区</c:if>
                                        </td>
                                        <td>${bean.mb}</td>
                                        <td class="table-action">
                                            <div class="btn-group1">
                                                ...
                                                <ul role="menu" class="dropdown-menu pull-right">
                                                	<sec:authorize ifAnyGranted="ROLE_81">
                                                    ...
                                                    <li><a href="${ctx }/shop/shopcolumn.action?parentid=${bean._id}"><i
                                                            class="fa fa-cog"></i>&nbsp;&nbsp;&nbsp;&nbsp;栏目配置</a></li>
                                                            
                                                            
                                                            
                                                   	<%-- <sec:authorize ifAnyGranted="ROLE_94"> --%>
                                                    <li><a href="${ctx }/shop/shoppro.action?comid=${bean._id}"><i
                                                            class="fa fa-shopping-basket"></i>&nbsp;&nbsp;&nbsp;商品管理</a>
                                                    </li>
                                                    <%-- </sec:authorize> --%> 
                                                    <sec:authorize ifAnyGranted="ROLE_101">
                       ...
                       <div class="col-sm-6">
                            <div class="mb-20">
                                ...
                                <select id="type" name="type" class="select2 hang40"
                                    ...
                                    <option value="4">会员区</option>
                                    <option value="5">特约区</option>
                                </select>
                                <label class="error" for="color"></label>
                            </div>
                        </div>
