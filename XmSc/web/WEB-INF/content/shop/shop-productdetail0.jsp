...
<head>
   ...
   <!--mjy添加开始--> 
		...
		<script type="text/javascript" src="${ctx}/xmMobile/js/jquery.min.js"></script>
		<script type="text/javascript" src="${ctx}/xmMobile/js/jquery.SuperSlide.2.1.1.js"></script>
		...
		<script type="text/javascript">
			$(function(){ 
		        //选项卡2
		        jQuery(".slideTxtBox12").slide({trigger:"click"});
...
<main style="position: relative;padding-top: 44px;">
        ...
        <div id="banner_box" class="box_swipe overflow-hidden position-r" style="width:100%">
            <ul>
                <c:forEach items="${slide}" var="bean">
                    <li>
                        <a href="${bean.url}">
                            <img src="${filehttp}/${bean.picurl}" alt="" style="width:100%;"/>
                        </a>
                    </li>
                </c:forEach>
            </ul>
    ...
    <a href="#">
         <div class="col-12 clear  pt-10 bg-huang zi-6 weight500" style="padding:5px 4%;">
            <font size="1">
                <font size="2">
                    <div class="clear zi-6 weight500 line-height25" style="color:#333333;overflow: hidden;">
                      <div class="title" id="" style="width: 70%; line-height:25px; float: left;">
                      	<span style="float:left; margin:0px 10px 0 0;  padding:0px;  line-height:20px;"><font>熊猫商场</font>自营</span>${entity.ptitle} 
                      </div>          
   	...
   	<div class="detail_shop_box_v3">
   		...
   		<div class="shop-go">
   			...
   			<c:if test="${entity.comid==14}">
                  <a href="${ctx}/shop/shoppro!vipwareList.action?custid=${custid}&agid=${agid}&lscode=${lscode}&goodstype=4">进入店铺</a>
            </c:if>
            <c:if test="${entity.comid!=14}">
   	...
   	<div class="cpgg" style="padding:20px 10px;" >
   	  <span>规格选择</span><span onclick="showspec(0)" style="float:right; "><i class="iconfont" style="font-size:1.5rem;" >&#xe6a7;</i></span> 
   	</div>
   	<style>
   	.cpgg p{line-height:20px; }
   	.cpgg p span{ color:#333;  }
   	</style>
   	<div class="cpgg" style="padding:20px 10px;" >
   	<a href="${ctx}/shop/shop!useraddress.action?lscode=${lscode}&custid=${custid}&agid=${agid}&address=ok&backurl=/shop/shop!shopproduct.action?custid=${custid}&agid=${agid}&lscode=${lscode}&pid=${entity._id}">
   	  <span style="float:right; "><i class="iconfont" style="font-size:1.5rem;" >&#xe6a7;</i></span>
   	</a>
   	  <p><span>送至：</span><span>${ address.province }${ address.city }${ address.county }${ address.address }</span> </p>
   	</div>
   	<style>
   	   .cpgg span{ font-size:14px; }
   	   .tab-switch a{ font-size:14px; }
   	</style>
    ...
    <div class="width-10 clear pl-5 pr-5 pt-5 img-100 goodsdetails goodsdetailson" id="contxt">
    	...
    	<%-- ${entity.context}   --%>   
    	<!--mjy添加开始-->
    	<div class="slideTxtBox12">
		<div class="hd">
			<ul><li>商品介绍</li><li>规格参数</li><li>售后保障</li></ul>
		</div>
		<div class="bd" style="margin-top: 0px;" >
			<ul>
				<div class="goodshow">
				${entity.context} 
					<%-- <img src="${ctx}/xmMobile/images/show1.jpg" alt="">
					<img src="${ctx}/xmMobile/images/show2.png" alt="">
					<img src="${ctx}/xmMobile/images/show3.png" alt="">
					<img src="${ctx}/xmMobile/images/show4.png" alt="">
					<img src="${ctx}/xmMobile/images/show5.png" alt="">
					<img src="${ctx}/xmMobile/images/show6.png" alt="">
					<img src="${ctx}/xmMobile/images/show7.png" alt=""> --%>
				</div>
			</ul>
			<ul>
				<div class="goodshow">
...
<div class=" button_foot hang40 bg-bai zi-bai shadow-wai cmp640">
	 <div class="col-6">
	 		<c:if test="${entity.comid==14}">
				<div class="col-4 txt-c zi-6 hang40" onclick="window.location.href='${ctx}/shop/shoppro!vipwareList.action?custid=${custid}&agid=${agid}&lscode=${lscode}&goodstype=4'">
            </c:if>
            <c:if test="${entity.comid!=14}">
            	<div class="col-4 txt-c zi-6 hang40" onclick="window.location.href='${ctx}/shop/shop!index.action?&custid=${custid}&agid=${agid}&lscode=${lscode}&comid=${entity.comid}'">
            </c:if>
	         <font size="4">
	             <div class="hang20">
	     ...
	     <div class="col-4 txt-c zi-6 hang40 position-r" onclick="window.location.href='${ctx}/shop/shop!shoppingcar.action?custid=${custid}&agid=${agid}&lscode=${lscode}'">
	         <font size="4">
	             <div class=" hang20">
	     ...
	     <div class="col-4 txt-c zi-6 hang40" id="alertBtn" >
	 		<font size="4">
	             <div class=" hang20">
	              <i class=" fa fa-user-circle-o line-height25"></i>
