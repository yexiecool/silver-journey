...
<script type="text/javascript">
	...
	function del(id) {
		if (confirm('确实要删除吗?')) {
			...
			location.href = "${contextPath}/web/advertising!delete.action?_id=" + id;
	...
	function upd(id, title, url,sort) {
		$('#_id').val(id);
		$('#title').val(title);
    ...
    if($("#url").val()==""){
     $("#url").val($("#fileupload").val());
    $("#path").val($("#upresult").val().substring(0,$("#upresult").val().indexOf(",")));
	...
	<section>
		...
		<div class="mainpanel">
			...
			<form id="custinfoForm" name="custinfoForm" method="post"
				action="${contextPath}/web/advertising.action?type=${type}">
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped table-primary mb30">
									...
									<tbody>
										<c:forEach items="${advertList}" var="bean">
											<tr>
												...
												<td class="table-action">
													...
													<div class="btn-group1">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															...
															<li><a
																href="javascript:upd('${bean._id}','${bean.title}','${bean.url}',${bean.sort});">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="inscxForm" action="${ctx }/web/advertising!save.action"
						class="form-horizontal" method="post" onsubmit="return check()">
						<input type="hidden" id="_id" name="_id" />
						<input type="hidden" id="path" name="path" /> 
						<input type="hidden" id="url" name="url" />
						<input type="hidden"  name="type" value="${type}" />
						<input type="hidden" id="upresult" />
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input type="text" id="fileupload" class="form-control"
											placeholder="请输入" />
