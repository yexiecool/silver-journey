...
<script type="text/javascript">
	...
	function del(id) {
		if (confirm('确实要删除吗?')) {
			...
			location.href = "${contextPath}/web/picture!delete.action?_id=" + id;
	...
	<section>
		...
		<div class="mainpanel">
			...
			<form id="custinfoForm" name="custinfoForm" method="post"
				action="${contextPath}/web/picture.action?">
						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-striped table-success mb30">
									...
									<tbody>
										<c:forEach items="${pictureList}" var="bean">
											<tr>
