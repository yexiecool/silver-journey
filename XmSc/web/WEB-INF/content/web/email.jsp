...
<script type="text/javascript">
	function del(id) {
		if (confirm('确实要删除吗?')) {
			...
			location.href = "${contextPath}/web/email!delete.action?_id="
					+ id;
	...
	<section>
		...
		<div class="mainpanel">
			...
			<form id="custinfoForm" name="custinfoForm" method="post"
				action="${contextPath}/mvccol/wxarticle.action?">

				<div class="pageheader">

					<h2>
						<i class="fa fa-user"></i>微网站 <span>微信图文</span>
					</h2>
						...
						<div class="row-pad-5">
							...
							<div class="form-group col-sm-1d">
								<input type="text" name="wxname" value="${wxname}"
									placeholder="公众号名称" class="form-control" />
							</div>
												...
												<td class="table-action">
													...
													<div class="btn-group1">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															<li><a
																href="javascript:upd('${bean._id}',${bean.sort},'${bean.pic}','${bean.title}');">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="inscxForm" action="${ctx }/mvccol/wxarticle!save.action"
			...
			<div class="modal-content">
				<div class="modal-header">
					<button aria-hidden="true" data-dismiss="modal" class="close"
						type="button">&times;</button>
					<h4 class="modal-title">
						<i class="fa fa-leaf"></i> 更新数据
					</h4>
				</div>
				<div class="modal-body">
					<form id="inscxForm" action="${ctx }/mvccol/wxarticle!gethtml.action"
						class="form-horizontal" method="post">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="form-group col-sm-1d">
										<s:select name="type" id="type1" cssClass="form-control"
											list="#{'0':'风景','1':'书画','2':'新闻','3':'汽车'}" listKey="key"
											listValue="value">
										</s:select>
									</div>
