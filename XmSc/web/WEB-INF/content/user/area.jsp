					...
					<div class="breadcrumb-wrapper1">
						<div class="input-group ">
							<div style="border-radius:3px; height:40px;padding-left:10px;" class="btn-primary">
								<sec:authorize ifAnyGranted="ROLE_137">
												...
												<td class="table-action">
													<div class="btn-group1">
														...
														<ul role="menu" class="dropdown-menu pull-right">
															<sec:authorize ifAnyGranted="ROLE_138">
															<li><a href="javascript:upd('${bean._id}');"> <i
																	class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;修改</a>
															</li>
															</sec:authorize>
															<sec:authorize ifAnyGranted="ROLE_140">
															<li><a href="${contextPath}/user/area.action?parentId=${bean._id}"> <i
																	class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;添加下级地区</a>
															</li>
															</sec:authorize>
															<sec:authorize ifAnyGranted="ROLE_139">
