...
<head>
		...
		<style type="text/css">
			...
			.share-tit{
				width: 180px; background:#54d86b; border-radius:5px;
				height: 36px;
				line-height: 36px;
	...
	<body>
		<header class="mui-bar mui-bar-nav" style="background: #141534; box-shadow: none;">
		    ...
		    <h1 class="mui-title"  style="color:#fbfaff;">我的分享</h1>
		    <!--<span class="mui-pull-right">保存到手机</span>-->
		</header>
		<div class="mui-content" style="padding-top: 10px;background:url('${ctx}/xmMobile/images/kjfx1.jpg') no-repeat top center; background-size:100% 100%; ">
		    ...
		    <div class="mui-row">
		    	...
		    	<div class="share">
		    		<div class="share-logo">
		    			...
		    			<p  style="color:#7cc3df; font-size:16px;">会员编号：<span>${user.no}</span></p>
		    		</div>
		    		<div class="share-canvas" id="qrcode"></div>
		    		<div class="share-tit"  >
		    			我的推广二维码
		    		</div>
		    		<div class="share-txt" style="color:#7cc3df !important;">
		    			全球首家数字资产购物商城
		    		</div>
		    	</div>
		    </div>
