...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/suc/drawboxyzm!getrecharge.action" >
    
    <div class="pageheader">
      <h2><i class="fa fa-user"></i>系统管理 <span>盼盼币充值记录查询</span></h2>
    </div>
                ...
                <table class="table table-primary mb30" >
                    ...
                    <tbody>
                      ...
                      <tr>
                      	<td>${bean.vipno}</td>
                      	<td>${bean.quantity}</td>
                      	<td>${bean.rechargeName}</td>
                      	<td><fmt:formatDate pattern='yyyy-MM-dd HH:mm' value='${bean.rechargeDate}'/></td>
