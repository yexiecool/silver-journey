...
function exp() {
	...
	location.href = "${ctx }/suc/integrall!integeralLLBfromexp.action?comid=${comid}&sel_state="+sel_state+"&sel_insdate="+sel_insdate+"&sel_enddate="+sel_enddate+"&sel_type="+sel_type;
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-user"></i>系统管理 <span>乐乐币管理</span><span>总数：${sum }</span></h2>
