...
<!-- <header style="width: 100%;height: 40px;line-height: 40px;text-align: center;padding: 0 10px;background: #fff;">
	<a href="javascript:history.go(-1);" style="font-size: 18px; float: left; color: #000; width: 30px; display: inline-block; height: 40px; line-height: 40px;"
...
<main class="lock cmp640" id="section1"> 
    <div class="bg-hui-92 zi-bailine-height40 cmp640 line-bottom">
        <a href="#">
            ...
            <div style="margin: 10px 0;line-height:20px;"><font size="2">${setting.names}总计：<i class="zi-cheng" style="float: right;margin-right: 15px;"><fmt:formatNumber value='${jf.llzvalue}'  pattern="0.00"/></i></font></div>            	
   ...
   <div class="txt-c zi-cheng  div-group-5">
        ...
        <div class="line-left1 line-top line-bottom line-right border-radius5" style="padding-bottom:10px; ">
            ...
            <a href="javascript:void(0)">
             ...
             <a href="${ctx}/suc/integral!web.action?custid=${custid}&agid=${agid}&lscode=${lscode}" style="color:#fff; padding:5px; font-size:12px; background-color:#ff5500; border-radius:5px;" >返回PADA明细</a>
        </div>
    </div>
