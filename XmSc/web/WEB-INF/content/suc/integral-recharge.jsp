...
function exp() {
	...
	location.href = "${ctx }/suc/integral!integeralfromexp.action?comid=${comid}&sel_insdate="+sel_insdate+"&sel_enddate="+sel_enddate+"&sel_type="+sel_type;
}
</script>
</head>
...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/suc/integral!recharge.action" >
