...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/suc/integral!shopping.action" >
    
    <div class="pageheader">
      <h2><i class="fa fa-user"></i>系统管理 <span>盼盼币管理</span><span>总数：${sum }</span></h2>
                ...
                <div class="panel-body fu10">
                    <div class="row-pad-5">
                    	...
                    	<div class="form-group col-sm-2">
			            	<select  id="sel_type"  name="sel_type" class="form-control "  data-placeholder="请选择盼盼币类型 ">
                    ...
                    <tbody>
                      ...
                      <tr>
                      	...
                      	<c:choose>
                      	  ...
                      	  <c:when test="${bean.type == 'order_cashback'}">消费累积</c:when>
