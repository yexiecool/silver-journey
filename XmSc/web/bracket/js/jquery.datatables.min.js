...
(function (za, O, l) {
    var N = function (h) {
        ...
        p.defaults = {aaData: null, aaSorting: [
            ...
            }, fnStateSaveParams: null, iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {oAria: {sSortAscending: ": 排列升", sSortDescending: ": 排列降"}, oPaginate: {sFirst: "首页", sLast: "尾页", sNext: ">", sPrevious: "<"},
                sEmptyTable: "没有可用数据", sInfo: "显示 _START_ - _END_ 共 _TOTAL_ 个", sInfoEmpty: "Showing 0 to 0 of 0 entries", sInfoFiltered: "(从 _MAX_ 条内 找到)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: " _MENU_ ", sLoadingRecords: "加载...", sProcessing: "处理...", sSearch: "搜索:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "未找到"}, oSearch: h.extend({}, p.models.oSearch), sAjaxDataProp: "data", sAjaxSource: null, sDom: "lfrtip", sPaginationType: "simple_numbers",
