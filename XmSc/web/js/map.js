...
function init() {
	...
	if (mapType == "baidu" || mapType == null) {
		...
		var opts2 = {offset: new BMap.Size(10, 27)};       //控制地图类型控件位置
...
/*编写自定义函数,创建标注*/
function addMarker(point, content, i) {
  var marker;
  setMarkerPro();
  //百度
  if (mapType == "baidu"){
...
function polygonUpdate() {
	...
	polygon.removeEventListener("mouseover", polygonEnableEditing);
