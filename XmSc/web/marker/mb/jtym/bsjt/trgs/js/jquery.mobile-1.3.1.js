...
$.Widget.prototype = {
	...
	option: function( key, value ) {
		...
		if ( typeof key === "string" ) {
			// handle nested keys, e.g., "http://weixin.aduer.com/js/foo.bar" => { foo: { bar: ___ } }
			options = {};
			parts = key.split( "." );
			key = parts.shift();
			if ( parts.length ) {
...
(function( $, window, undefined ) {
  ...
  // path of the included "http://weixin.aduer.com/js/document-domain.html" file, which can be renamed or
  ...
  // Usage:
  // 
  // jQuery.fn.hashchange.src = 'path/to/file.html'/*tpa=http://weixin.aduer.com/js/path/to/file.html*/;
...
$.widget( "http://weixin.aduer.com/js/mobile.page", $.mobile.widget, {
	options: {
		theme: "c",
		domCache: false,
