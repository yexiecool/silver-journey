...
function  init_ioc(fg,gf){
  ...
  var submitData = {
		...
		$.post('${ctx}/pub/font!ajaxweb.action', submitData, function(json) {
			  if (json.state == 0) {
			  var  html='';
			  var  list=json.list;
			   for (var i = 0; i < list.length; i++) {
			     html+='<div class="pb-10 col-sm-1" onclick="set_ioc(\''+fg+'\',\''+list[i].value+'\')">'
			          +'<font class="fa '+list[i].value+'" style="font-size:20px"></font>'
