...
<script> 
        ...
        function keyup() {
            ...
            if(parseInt(quantity)*parseInt(entity.jfdh)>'${jf}'){
              jfbz_show();
            }
        } 
        /*商品数量+1*/
        function numAdd() {
            ...
            if (num_add >99999) {
                ...
                $("#totalPrice").html("积分"+Num.toFixed(2)); 
            }
             if(parseInt(quantity)*parseInt(entity.jfdh)>'${jf}'){
               jfbz_show();
            }
                        ...
                        <font size="2">
                            ...
                            <div class=" pull-left weight500">
                                <div class="sl hang30" style="line-height:35px;">
                                    <span class="zi-cheng" id="totalPrice">积分<fmt:formatNumber value='${entity.jfdh}' pattern="0.0#"/></span>
                                </div>
                            </div>
