...
<div class="fullscreen cmp640 bg-hei-5 lock" id="emailtx">
    <div class="overflow-hidden width-10">
        <a href="javascript:emailtx_hide()">
            ...
            <div class="maring-a position-r border-radius5 div-group-15 pt-45 bg-bai" style="width:280px;">
                ...
                <div class=" width-10 border-radius5 zi-hui-tq overflow-hidden">
                    <font size="2">
                        ...
                        <div class="weight500 line-height25">&nbsp&nbsp&nbsp尊敬的：<i class="zi-green">${user.nickname}</i><i class="zi-green">您有${emailcount}条新消息！</i></div>
                    </font>
                </div>

                <div class="width-10 pt-15">
                    <div class="button_group1" onclick="window.location.href='${ctx}/email/email!web.action?custid=${custid}&lscode=${lscode}'">
                        <div class="width-8 maring-a border-radius3 btn-green zi-bai txt-c hang30 line-height30">
                           立即查看
                        </div>
                    </div>
                    <div class="button_group1" onclick="emailtx_hide()">
                        <div class="width-8 maring-a border-radius3 btn-green zi-bai txt-c hang30 line-height30">
                            稍后查看
                        </div>
                    </div>
...
<script>
function  emailtx_hide(){
 $("#emailtx").hide();
}
function  emailtx_show(){
 $("#emailtx").show();
}
