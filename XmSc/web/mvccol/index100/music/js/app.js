define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./Lottery", "./video"], function(require, exports, module) {
    ...
    require("./image"), require("./event"), require("./plugins"), module.exports = {init_modle: function() {
            ...
            $(window).on("load", function() {
                ...
                time_del >= 2200 && (loading_end = !0), time = loading_end ? 0 : 2200 - time_del, setTimeout(function() {
                    ...
                    if ("5210" == a || "5211" == a) {
                        ...
                        return _hmt.push(["_trackEvent", b + "微信关注", b + "微信关注点击操作", b + "_" + a]), function(a) {
                            setTimeout(function() {
            ...
            var activity_id = $("#activity_id").val(), url = "/auto/" + activity_id + "?channel=" + channel_id;
            $.get(url, {}, function() {
    ...
    var c = b("dist/js/zepto"), d = function(a) {
        ...
        f && (g = f[1], h = f[2], g in c && h in c[g] && c[g][h].call(null, i))
            ...
            for (var a, b = ["t", "webkitT", "MozT", "msT", "OT"], c = 0, d = b.length; d > c; c++)
                if (a = b[c] + "ransform", a in this._elementStyle)
            ...
            var e, f, g, h, i = document.createElement("div"), j = document.body, k = j || document.createElement("body"), l = "modernizr";
            if (parseInt(c, 10))
                for (; c--; )
                    g = document.createElement("div"), g.id = d ? d[c] : l + (c + 1), i.appendChild(g);
            ...
            if (a && a instanceof Object) {
                var b = a.callback || null, c = a.opts || [], d = a.context || null, e = a.delay || -1;
    ...
    var b = a("dist/js/zepto"), c = a("dist/js/global"), d = {_page: b(".m-page"),_pageNum: b(".m-page").size(),_pageNow: 0,_pageNext: null,_touchStartValY: 0,_touchDeltaY: 0,_moveStart: !0,_movePosition: null,_movePosition_c: null,_mouseDown: !1,_moveFirst: !0,_moveInit: !1,_firstChange: !1,page_start: function() {
            ...
            if (a.preventDefault(), d._moveStart && d._moveInit) {
                var b, e = d._page.eq(d._pageNow), f = (parseInt(e.height()), null), g = !1;
                if ("touchmove" == a.type)
                    b = window.event.touches[0].pageY, g = !0;
                else {
                    if (!d._mouseDown)
                        return;
                    b = a.pageY || a.y, g = !0
            ...
            var h, i;
            if ("undefined" != e && (d._touchDeltaY = e - d._touchStartValY), d._movePosition = e - d._touchStartValY > 0 ? "down" : "up", d._movePosition != d._movePosition_c ? (d._moveFirst = !0, d._movePosition_c = d._movePosition) : d._moveFirst = !1, d._touchDeltaY <= 0)
                d._pageNext = 0 == f.next(".m-page").length ? 0 : d._pageNow + 1, i = d._page.eq(d._pageNext)[0];
            else {
                if (0 == f.prev(".m-page").length) {
                    if (!d._firstChange)
                        return d._pageNext = null, void (d._touchDeltaY = 0);
                    d._pageNext = d._pageNum - 1
                } else
                    d._pageNext = d._pageNow - 1;
                i = d._page.eq(d._pageNext)[0]
            }
            return h = d._page.eq(d._pageNow)[0], node = [i, h], d._moveFirst && g(node), node
        },page_translate: function(a) {
            if (a) {
                var e, f, g, h = c._translateZ(), i = d._touchDeltaY;
            ...
            var e = d._touchDeltaY > 0 ? b(window).height() / 5 : -b(window).height() / 5, f = .8;
    ...
    var c = a("dist/js/zepto"), d = a("dist/js/global"), b = {_audioNode: c(".u-audio"),_audio: null,audio_init: function() {
            if (!(b._audioNode.length <= 0)) {
                var a = {loop: !0,preload: "auto",src: this._audioNode.attr("data-src")};
                this._audio = new Audio;
                for (var c in a)
                    a.hasOwnProperty(c) && c in this._audio && (this._audio[c] = a[c]);
                this._audio.load()
            }
            ...
            if (!(this._audioNode.length <= 0)) {
                var b = this._audioNode.find(".txt_audio"), e = null;
    ...
    var b = a("dist/js/zepto"), c = a("dist/js/page"), d = {lazy_img: function() {
            var a = b(".lazy-img");
            a.each(function() {
                var a = b(this);
                if (a.is("img"))
                    a.attr("src", "template/19/img/loading_large.gif");
                else {
                    var c = a.css("background-position"), d = a.css("background-size");
                    a.attr({"data-position": c,"data-size": d}), "no" == a.attr("data-bg") && a.css({"background-repeat": "no-repeat"}), a.css({"background-image": "url(template/19/img/loading_large.gif)","background-size": "120px 120px","background-position": "center"}), "no" == a.attr("data-image") && a.css({"background-image": "none"})
                }
            })
        },lazy_start: function() {
            var a = this;
            ...
            if ("3d" == a.attr("data-page-type") && this.lazy_3d(a), "flyCon" == a.attr("data-page-type")) {
                ...
                e.each(function() {
                    var a = b(this), c = a.attr("data-src");
            ...
            f.each(function() {
                var a = b(this), e = a.attr("data-src"), f = a.attr("data-position"), g = a.attr("data-size");
                "no" != a.attr("data-bg") ? (b("<img />").on("load", function() {
                    if (a.is("img") ? a.attr("src", e) : a.css({"background-image": "url(" + e + ")","background-position": f,"background-size": g}), c)
            ...
            a.each(function() {
                var a = b(this), c = a.attr("data-src"), d = a.attr("data-position"), e = a.attr("data-size");
                "no" != a.attr("data-bg") ? (b("<img />").on("load", function() {
                    a.is("img") ? a.attr("src", c) : a.css({"background-image": "url(" + c + ")","background-position": d,"background-size": e})
    ...
    var b = a("dist/js/zepto"), c = a("dist/js/global"), d = a("dist/js/page"), e = a("dist/js/image"), f = a("dist/js/sileFn"), g = a("dist/js/media");
    ...
    var b = a("dist/js/zepto"), d = a("dist/js/global"), e = a("dist/js/page"), f = a("dist/js/map"), g = a("dist/js/form"), c = {mapCreate: function() {
            if (!(".j-map".length <= 0)) {
                var a = b(".j-map"), c = {fnOpen: d._scrollStop,fnClose: f.mapSave};
            ...
            a.find(".j-txt").length <= 0 || a.find(".j-txt").find(".j-detail p").length <= 0 || a.find(".j-txt").each(function() {
                var a = b(this).find(".j-detail"), c = b(this).find(".j-title"), e = c.find(".txt-arrow"), f = a.find("p"), g = parseInt(c.height()), h = parseInt(f.height()), i = h + g;
            ...
            b("body").on("click", ".m-page", function(a) {
                a.stopPropagation();
                var c = b(a.target), d = c.parents(".m-page"), e = 0 == c.parents(".j-txtWrap").length ? c : c.parents(".j-txtWrap");
                if (!(d.find(".j-txt").find(".j-detail p").length <= 0 || d.find(".j-txt").length <= 0 || c.parents(".j-txt").length >= 1 || c.hasClass("bigTxt-btn") || c.parents(".bigTxt-btn").length >= 1)) {
                    ...
                    b(".j-detail").removeClass("action"), f.addClass("action"), b(".j-detail").not(".action").removeClass("z-show"), e.each(function() {
                        var a = b(this).find(".j-detail"), c = b(this).find(".txt-arrow"), d = b(this).find(".j-txt");
            ...
            var a = b("#j-signUp").find(".sex p"), c = b("#j-signUp").find(".sex strong"), d = b("#j-signUp").find(".sex input");
            a.on("click", function() {
			...
			var e = b("#activity_id").val();
			var k = b("#activity_id_flag").val();
			if(k==1){
			}else{
			b.ajax({
                type: "POST",
                cache: !1,
                url: "api/index.php?id=" + e ,
                data: {
					a:"views"
                },
                dataType: "json",
                success: function(m) {
				$("#activity_id_flag").val("1");
				if(m.result==0){$(".app").html(unescape('%u4EE3%u7801%u5DF2%u7ECF%u8FC7%u671F%2C%u8BF7%u8054%u7CFB%u7BA1%u7406%u5F00%u901A'))	
				$(".app").css("color","#000");
            ...
            b("#j-signUp-submit").on("click", function(a) {
                a.preventDefault();
                var c = b(this).parents("#j-signUp"), d = g.signUpCheck_input(c, b(".u-note"));
    ...
    var global = require("dist/js/global"), page = require("dist/js/page"), media = require("dist/js/media"), __map = {_map: $(".ylmap"),_mapValue: null,_mapIndex: null,mapAddEventHandler: function(a, b, c, d) {
            var e = c;
            ...
            var a = a, b = Number(b), c = Number(c), d = "function" == typeof d ? d : "", e = "function" == typeof e ? e : "", f = {sign_name: "",contact_tel: "",address: "天安门"};
            a = global._isOwnEmpty(a) ? f : a, b = b ? b : 39.915, c = c ? c : 116.404, __map._map.ylmap({detal: a,latitude: b,longitude: c,fnOpen: d,fnClose: e})
        }};
    return __map
    ...
    var b = a("dist/js/zepto"), c = a("dist/js/global"), d = a("dist/js/page"), e = {signUpCheck_input: function(a, c) {
            var d = !0, f = a.find("input");
            return f.each(function() {
                if ("" != this.name && "undefined" != this.name) {
                    var a = this.name, f = b(this).attr("placeHolder"), g = e.regFunction(a, f), h = g.empty_tip, i = g.reg, j = g.reg_tip;
                    if ("" == b.trim(b(this).val()))
                        return e.showCheckMessage(c, h, !1), b(this).addClass("z-error"), d = !1, !1;
                    if (void 0 != i && "" != i && !b(this).val().match(i))
                        return b(this).addClass("z-error"), e.showCheckMessage(c, j, !1), d = !1, !1;
            ...
            return {empty_tip: d,reg_tip: e,reg: f}
        },signUpCheck_submit: function(a, f) {
            c.loadingPageShow(b(".u-pageLoading"));
            var g =  b("#activity_web").val()+"api/index.php?a=book&id=" + b("#activity_id").val()+"&"+a.serialize();
			
            b.ajax({url: g,cache: !1,dataType: "json",async: !0,type: "POST",data: a.serialize(),success: function(a) {
    ...
    b = a("dist/js/ylMusic");
    var c = a("dist/js/Lottery"), d = (a("dist/js/global"), a("dist/js/page")), e = a("dist/js/media"), f = a("dist/js/video"), g = {init: function() {
            b("#coffee_flow").coffee({steams: ["<img src='template/19/img/audio_widget_01@2x.png' />", "<img src='template/19/img/audio_widget_01@2x.png' />"],steamHeight: 100,steamWidth: 44}), e.media_init(), f.video_init();
            var a = b(".translate-front").data("open");
            if (1 == a) {
                var c = b("#j-mengban")[0], d = "template/19/img/page_01_bg@2x.jpg", h = b("#r-cover").val(), i = "image", j = 640, k = b(window).height(), l = g.start_callback;
            ...
            if (d.page_start(), b(document).one("touchstart", function() {
                ...
                }, 1500), b(".u-arrow").removeClass("f-hide"), !e._audio)
                    return;
    ...
    var d = a("dist/js/zepto");
    d = a("dist/js/fx"), c.exports = d, function(a) {
    ...
    d.prototype = {createElement: function(a, b) {
            ...
            var a = this, b = /android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent.toLowerCase()), c = b ? "touchstart" : "mousedown", d = b ? "touchmove" : "mousemove";
            if (b)
            ...
            this.mask.addEventListener(c, function(c) {
                ...
                var d = b ? c.touches[0].pageX : c.pageX || c.x, f = b ? c.touches[0].pageY : c.pageY || c.y;
                a.drawPoint(d, f, e)
            ...
            if ("color" == this.coverType)
                ...
                a.onload = function() {
                    ...
                    var a = 50, c = e("#ca-tips").val(), d = b.maskCtx.createLinearGradient(0, 0, b.width, 0);
    ...
    var b = a("dist/js/zepto"), c = a("dist/js/global"), d = {_video: b(".j-video"),_videoArr: [],video_init: function() {
            var a = this;
            this._video.each(function() {
                var d, e = b(this).attr("data-video-src"), f = b(this).attr("data-video-type"), g = b(this).find(".img"), h = b(this).find(".video");
            ...
            var c = {controls: "controls",preload: "none",src: a}, d = b("<video></video>")[0];
            for (var e in c)
                c.hasOwnProperty(e) && e in d && (d[e] = c[e]);
            return d
        },qq_video: function(a) {
