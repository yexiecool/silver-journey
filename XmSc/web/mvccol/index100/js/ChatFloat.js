var SocketIp = "http://kf.weimob.com/js/115.29.229.136";
var TimeInterval;
var getType = 1;
...
window.ChatFloat = function (options) {
    ...
    if (options && options.AId) {
        ...
        if (options.IsTest != undefined && options.IsTest) {
            SocketIp = "http://kf.weimob.com/js/112.124.16.233";
...
ChatFloat.prototype = {
    initialize: function (options, weimobid, msgcount, socket) {
        ...
        mydiv.style.background = "url('../images/MobileChatFloat.png'/*tpa=http://kf.weimob.com/images/MobileChatFloat.png*/) no-repeat 0px 0px";
