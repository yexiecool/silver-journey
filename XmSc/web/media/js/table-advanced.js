var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var sOut = '<table>';
            var obj = eval(aData[1]);
            for(var j=0;j<obj.length;j++){
            	var buy = eval(obj[j]);
            	sOut += '<tr><td></td>';
                sOut += '<td>名称:</td><td>'+buy.title+'</td>';
                sOut += '<td><img src="'+'http://www.chemingpian.com/'+buy.picurl+'" style="height:100px;"></td>';
                sOut += '<td>数量:</td><td>'+buy.num+'</td>';
                sOut += '<td>价格:</td><td>'+buy.price+'</td>';
